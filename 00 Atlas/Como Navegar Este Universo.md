...
1. Comece por [[Universo como Corpo]].
...
No Graph View, procure por:

```query
tag:#universo-organismo
```

Ative tags e setas. As cores por pasta ajudam a diferenciar atlas, conceitos, analogias, modelos e visualizações.
